...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go@master -cflags "-g -O2 -Wall -D__TARGET_ARCH_${TARGET_GOARCH} -Wall" -target ${TARGET_GOARCH} -type mapKey filter ./_cprog/retina_filter.c -- -I../lib/_${TARGET_GOARCH} -I../lib/common/libbpf/_src
